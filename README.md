...
⚙️ Cấu hình Danh tính 
Sau khi chạy Terminal, chương trình sẽ yêu cầu nhập user_id của bạn và ID của dự án bạn đã phân tích. 
Nhập thông tin và chương trình sẽ tự setup cho bạn.
